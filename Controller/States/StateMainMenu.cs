...
namespace ShaRPG.Controller.States
{
        ...
        : State
    {
        ...
        override public void Update()
        {
            ...
            {
                CharacterBannerCreate(activeCharacter);
            }
            if (debugMode == true)
            {
            ...
            Gui.MenuOption(2, "(L)oad InitGameController");
        ...
        public void CharacterBannerCreate(CharacterModel activeCharacter)
        {
            int len = View.StringViewCharacter.ToStringBanner(activeCharacter).Length;
            string label = "   Active CharacterModel   ";
        ...
        public void SelectCharacter()
        {
            ...
            string choice = Gui.GetInputInt("CharacterModel Selection");

            try
            {
                activeCharacter = (CharacterModel?)characterList[Convert.ToInt32(choice)];
            }
            catch (Exception e)
            {
                Gui.Alert(e.Message);
